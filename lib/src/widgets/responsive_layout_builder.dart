import 'package:bills_out/src/layout/layout.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= BillsBreakpoints.small) {
          return small(context, child);
        } else if (constraints.maxWidth <= BillsBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        } else if (constraints.maxWidth <= BillsBreakpoints.large) {
